...
<b>Проект не обновлялся с августа 2020, но скоро это изменится. По результатам недавнего опроса выяснилось, что многим был бы удобнее формат веб-сайта и очень многие хотели бы распечатать материал, поэтому скорее всего библия скоро переедет в github pages, либо будет продублирована в таком формате, а также будет доступен гуглодок, откуда можно будет легко всё распечатать или сохранить в любом формате. Касаемо материала, то в закладках за этот период скопилось пару сотен полезных ссылок, сообществом было сообщено о некоторых неточностях, да и собственный взгляд на практике изменился на некоторые вещи. Так что stay tuned, скоро будут обновления!</b>

<spoiler title="Disclaimer, очень важно прочитать!">
ВНИМАНИЕ! В данный момент для того, чтобы увидеть материал целиком, нужно открыть первую или вторую часть (Manual part 1 или 2) в файлах (в мобильной версии нужно сначала нажать View code). Этот текст - лишь содержание. Пришлось их разбить ввиду ограничения на размер одного файла в 1 мб.<br>
Также хочу подчеркнуть, что это лишь мой конспект и он не претендует на какие-то попытки конкурировать с курсами или порталами. В данный момент этот материал от джуна – джунам, от intermediate – таким же, но будет полезен всем грейдам, тем более что часть материала далеко не начального уровня. Качество материала (особенно перевода) будет улучшаться по мере вычитки и вклада сообщества. 
Что касается источников и ресурсов, то список не полный. В первоначальном конспекте для себя я не сохранял ссылки, так что, если увидели авторский контент, прошу не ругаться. <br>
Если есть что исправить или дополнить – пишите в tg @VA610 /создавайте issue/форкайте и коммитьте!<br>
</spoiler>
